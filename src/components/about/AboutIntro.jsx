    ...
    <>
      <div id='about-intro' className='banner-image-text'>
        ...
        <img
          ...
          alt="Photo of Andrew Morgan speaking at MongoDB event"
      ...
      <div className="left-content">
        ...
        <p>This means that I spend a lot of my time on the road at customer sites. I typlically spend the first day teaching large groups of developers how to use MongoDB (especially if they have an RDBMS background). The second day is usually spent running design reviews, where I sit down with a design team to show them how best to use MongoDB for their specific application.</p>
